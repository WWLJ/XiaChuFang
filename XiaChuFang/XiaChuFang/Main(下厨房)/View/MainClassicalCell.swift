...
class MainClassicalCell: UITableViewCell {
    ...
    func setUpUI() {
        showImage = UIImageView.init(frame: CGRectMake(5, 5, UIScreen.mainScreen().bounds.size.width-10, 90))
        ...
        firstTitle?.font = UIFont.systemFontOfSize(15)
        firstTitle?.textAlignment = NSTextAlignment.Center
//        firstTitle?.textColor = UIColor.yellowColor()
